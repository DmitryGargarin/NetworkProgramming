...
//sockaddr* from - инфа о клиенте
//char* name - символьное имя сервера
...
//struct sockaddr* to - структура, ссылающаяся на клиента, который коннектится в предыдущей ф-и
//char* name - имя сервера
//ф-я должна отправлять клиенту имя сервера (т.е. name)
